      ...
      <div id="navbar">
        ...
        <div id="globNav" className="navbarElements">
          <ul>
            ...
            <li>
              <Link className="link" to="/kop"><p>Köp</p></Link>
            </li>
            <li>
              <Link className="link" to="/salj"><p>Sälj</p></Link>
            </li>
            <li>
